    ...
    var IconLayers = L.Control.extend({
        ...
        _getActiveLayer: function() {
            if (this._activeLayerId) {
                //retorna el layer ativo
                return this._layers[this._activeLayerId];
            } else if (length(this._layers)) {
                // o retorna el primer layer como activo
        ...
        _getPreviousLayer: function() {
            ...
            if (!activeLayer) {
                ...
                //devuelve el layer que va a dejar de estar activo
                return this._layers[this._previousLayerId];
            } else {
                return find(this._layers, function(l) {
                    //mientras no halla cambios de layer retorrna true
        ...
        _getInactiveLayers: function() {
            ...
            //retoran layer que no estan activos  y no son layer previos 
            return ar;
        },
